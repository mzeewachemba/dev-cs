...
def main():
    ...
    jobs = []
    jobs = []
    job1 = Job(1, 0.0, 10, 3, 1, Status.CREATED, MS.get_memory_size("10MB"))
    jobs.append(job1)
    job2 = Job(2, 2, 1, 2, 1, Status.CREATED, MS.get_memory_size("6MB"))
    jobs.append(job2)
    job3 = Job(3, 4, 3.0, 1, 1, Status.CREATED, MS.get_memory_size("12MB"))
    jobs.append(job3)
    job4 = Job(4, 8, 5, 5, 1, Status.CREATED , MS.get_memory_size("8MB"))
    jobs.append(job4)
