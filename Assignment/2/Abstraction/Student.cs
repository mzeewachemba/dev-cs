...
namespace Abstraction
{
    internal class Student : ICloneable, IComparable<Student>
    {
        ...
        public object Clone()
        {
            ...
            snew = (Student)this.MemberwiseClone(); //typecasting
            //memberwise clone present in every class as they extend from object class
            //but the array for test score will point to the same memory
