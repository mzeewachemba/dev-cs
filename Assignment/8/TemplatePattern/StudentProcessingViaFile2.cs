...
{
    internal class StudentProcessingViaFile2 : TemplateStudent
    {
        ...
        public StudentProcessingViaFile2(string infName, string outfName, IGradeStrategy igr) //passing Igradestrategy allows for flexibility in the future
        {
            inFileName = infName;
